...
def generate_documentation_ai(code: str):
...
def explore_code_ai(code: str, mode: str):
    return explore_code(code, mode)
...
def ask_followup_ai(code: str, question: str):
    return ask_followup(code, question)